...
<body>
    ...
    <br>
    <h2 class="text-center h1" style="color:#2334A2; text-shadow: 1.5px 1px 2px #525252;">Consumibles</h2>
    <br>
    ...
    <section class="container">
        ...
        <?php
         ...
         $sql = "SELECT * FROM productos WHERE categoria = 'Consumibles' ORDER BY 'subcategoria' ASC, 'nombre_producto' DESC";
