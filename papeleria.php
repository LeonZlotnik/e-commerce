...
<body>
    ...
    <br>
    <h2 class="text-center h1" style="color:#2334A2; text-shadow: 1.5px 1px 2px #525252;" >Papeleria</h2>
    <br>
    ...
    <section class="container">
        ...
        <?php
         ...
         $sql = "SELECT * FROM productos WHERE categoria = 'Papeleria' ORDER BY 'subcategoria' ASC, 'nombre_producto' DESC";
         $result = mysqli_query($db, $sql);
         while ($row = mysqli_fetch_array($result)){
        ?>
            
                <li class="card margin size" style="width:270px;" id="<?php echo $row['subcategoria']?>">
